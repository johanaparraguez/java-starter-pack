...
public class FrameListar extends javax.swing.JFrame {
    ...
    public FrameListar() {
        ...
        ArrayList<ClaseVeterinaria> lista = c.lista();
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            fila[4] = lista.get(i).getNombreMascota();
            fila[5] = lista.get(i).getSexoMascota();
            modelo.addRow(fila);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido", "Edad", "Sexo", "Nombre Mascota", "Sexo Mascota"
            }
        ) {
        ...
        jLabel1.setText("Lista Clientes registrados");
